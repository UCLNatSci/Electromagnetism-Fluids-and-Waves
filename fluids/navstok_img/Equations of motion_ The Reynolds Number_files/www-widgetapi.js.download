...
Xb&&(Wb=Xb?Xb[1]:"");if(Qb){var Yb=Ub();if(null!=Yb&&Yb>parseFloat(Wb)){Vb=String(Yb);break a}}Vb=Wb}var Zb=Vb,$b;if(z.document&&Qb){var ac=Ub();$b=ac?ac:parseInt(Zb,10)||void 0}else $b=void 0;var bc=$b;Ab();var cc=Nb()||H("iPod"),dc=H("iPad");!H("Android")||Bb()||Ab();Bb();var ec=H("Safari")&&!(Bb()||H("Coast")||H("Opera")||H("Edge")||H("Edg/")||H("OPR")||Ab()||H("Silk")||H("Android"))&&!(Nb()||H("iPad")||H("iPod"));var fc={},gc=null;var hc={jb:{value:!0,configurable:!0}};var ic=Object,jc=ic.freeze,kc=[];Array.isArray(kc)&&!Object.isFrozen(kc)&&Object.defineProperties(kc,hc);jc.call(ic,kc);var J=window;hb("csi.gstatic.com");hb("googleads.g.doubleclick.net");hb("pagead2.googlesyndication.com");hb("partner.googleadservices.com");hb("pubads.g.doubleclick.net");hb("securepubads.g.doubleclick.net");hb("tpc.googlesyndication.com");function lc(a,b){this.width=a;this.height=b}
...
function b(q){for(var t=g,p=0;64>p;p+=4)t[p/4]=q[p]<<24|q[p+1]<<16|q[p+2]<<8|q[p+3];for(p=16;80>p;p++)q=t[p-3]^t[p-8]^t[p-14]^t[p-16],t[p]=(q<<1|q>>>31)&4294967295;q=e[0];var x=e[1],A=e[2],v=e[3],L=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var P=v^x&(A^v);var E=1518500249}else P=x^A^v,E=1859775393;else 60>p?(P=x&A|v&(x|A),E=2400959708):(P=x^A^v,E=3395469782);P=((q<<5|q>>>27)&4294967295)+P+L+E+t[p]&4294967295;L=v;v=A;A=(x<<30|x>>>2)&4294967295;x=q;q=P}e[0]=e[0]+q&4294967295;e[1]=e[1]+x&4294967295;e[2]=
e[2]+A&4294967295;e[3]=e[3]+v&4294967295;e[4]=e[4]+L&4294967295}
...
return a[Sd]}
;function K(){hd.call(this);this.h=new Cd(this);this.ca=this;this.s=null}
F(K,hd);K.prototype[yd]=!0;K.prototype.addEventListener=function(a,b,c,d){Id(this,a,b,c,d)};
K.prototype.removeEventListener=function(a,b,c,d){Qd(this,a,b,c,d)};
...
K.prototype.P=function(){K.G.P.call(this);if(this.h){var a=this.h,b=0,c;for(c in a.listeners){for(var d=a.listeners[c],e=0;e<d.length;e++)++b,Bd(d[e]);delete a.listeners[c];a.h--}}this.s=null};
...
function fh(a,b,c,d){return I(a,function f(){var g=this,h,k,l,m,q,t,p,x,A,v,L,P;return y(f,function(E){switch(E.h){case 1:var O={mode:"readonly",D:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?O.mode=c:Object.assign(O,c);h=O;g.transactionCount++;k=h.D?3:1;l=0;case 2:if(m){E.v(3);break}l++;q=Math.round(R());sa(E,4);t=g.h.transaction(b,h.mode);O=new hh(t);O=ih(O,d);return w(E,O,6);case 6:return p=E.i,x=Math.round(R()),jh(g,q,x,l,void 0,b.join(),h),E.return(p);case 4:A=ta(E);v=Math.round(R());
L=Tg(A,g.h.name,b.join(),g.h.version);if((P=L instanceof V&&!L.h)||l>=k)jh(g,q,v,l,L,b.join(),h),m=L;E.v(2);break;case 3:return E.return(Promise.reject(m))}})})}
...
Lh.prototype.i=function(a,b,c){c=void 0===c?{}:c;return(this.options.va?Ih:Hh)(a,b,Object.assign({},c))};
Lh.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.va?Kh:Jh)(this.name,a)};var Nh;
...
;var Yh=gf("network_polling_interval",3E4);function Y(){K.call(this);this.B=0;this.N=this.l=!1;this.i=this.da();Zh(this);$h(this)}
oa(Y,K);function ai(){if(!Y.h){var a=B("yt.networkStatusManager.instance")||new Y;D("yt.networkStatusManager.instance",a);Y.h=a}return Y.h}
n=Y.prototype;n.J=function(){return this.i};
n.qa=function(a,b){a!==this.i&&((void 0===b?0:b)?this.L():this.i=a)};
...
n.Z=function(a,b){return K.prototype.Z.call(this,a,b)};
...
oa(ci,K);ci.prototype.J=function(){var a=B("yt.networkStatusManager.instance.isNetworkAvailable").bind(this.i);return a?a():!0};
ci.prototype.qa=function(a,b){b=void 0===b?!1:b;var c=B("yt.networkStatusManager.instance.networkStatusHint").bind(this.i);c&&c(a,b)};
...
function mg(a,b,c,d){function e(t){t=void 0===t?!1:t;var p;if(d.retry&&"www.youtube-nocookie.com"!=h&&(t||(p=yg(b,c,l,k)),p)){var x=g.onSuccess,A=g.onFetchSuccess;g.onSuccess=function(v,L){zg(p);x(v,L)};
c.onFetchSuccess=function(v,L){zg(p);A(v,L)}}try{t&&d.retry&&!d.ra.bypassNetworkless?(g.method="POST",d.ra.writeThenSend?ii(q,g):oi(q,g)):(g.method="POST",g.postParams||(g.postParams={}),xf(q,g))}catch(v){if("InvalidAccessError"==v.name)p&&(zg(p),p=0),Me(Error("An extension is blocking network request."));
...
aa:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var vi={K:[],I:[{Ba:ui,weight:500}]};function ui(a){a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
...
function bj(a){Ui(a.i,a,a.id);a.j=We(a.sa.bind(a));Ue(a.h,"load",function(){window.clearInterval(a.j);a.j=We(a.sa.bind(a))})}
...
g,k,t),500<=t);g++);navigator.vendor&&!k.hasOwnProperty("vendor")&&(k["device.vendor"]=navigator.vendor);g={message:f,name:h,lineNumber:q,fileName:l,stack:m,params:k,sampleWeight:1};f=Number(e.columnNumber);isNaN(f)||(g.lineNumber=g.lineNumber+":"+f);if("IGNORED"===e.level)e=0;else a:{e=yi();f=u(e.K);for(h=f.next();!h.done;h=f.next())if(h=h.value,g.message&&g.message.match(h.kb)){e=h.weight;break a}e=u(e.I);for(f=e.next();!f.done;f=e.next())if(f=f.value,f.Ba(g)){e=f.weight;break a}e=1}g.sampleWeight=
...
f=u(Object.keys(g));for(h=f.next();!h.done;h=f.next())h=h.value,d.postParams["client."+h]=g[h];if(g=N("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(f=u(Object.keys(g)),h=f.next();!h.done;h=f.next())h=h.value,d.postParams[h]=g[h];g=N("SERVER_NAME",void 0);f=N("SERVER_VERSION",void 0);g&&f&&(d.postParams["server.name"]=g,d.postParams["server.version"]=f)}xf(N("ECATCHER_REPORT_HOST","")+"/error_204",d)}try{Fi.add(e.message)}catch(L){}Gi++}}}}}else throw v;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function cj(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
